...
public class EjemploLocalDateTime {
    public static void main(String[] args) {
        ...
        /*Seria la union de LocalTime LocalDate, se maneja de la misma forma que las anteriores para su creacion*/
        LocalDateTime fechaTiempo = LocalDateTime.now();
        System.out.println("fechaTiempo = " + fechaTiempo);

        /*Creamos pasandole año, mes, dia, hora, minutos, segundos*/
