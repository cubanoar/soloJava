...
public class EjemploStreamFlatMapFactura {
    public static void main(String[] args) {
        ...
        usuarios.stream()
                /*Nos da la lista de facturas y la convertimos a stream*/
        ...
        for (Factura f : u1.getFacturas()) System.out.println("U1 " + f.getDescripcion().concat(u1.toString()));
        for (Factura f : u2.getFacturas()) {
            System.out.println("U2 ".concat(f.getDescripcion()).concat(" Cliente: ") + u2);
        }
